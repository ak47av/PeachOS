...
#define PEACHOS_PROGRAM_VIRTUAL_STACK_ADDRESS_START 0x3FF000 // all tasks share the same virtual address and stack address start
#define PEACHOS_PROGRAM_VIRTUAL_STACK_ADDRESS_END PEACHOS_PROGRAM_VIRTUAL_STACK_ADDRESS_START - PEACHOS_USER_PROGRAM_STACK_SIZE // stack grows downwards by default in intel

#define USER_DATA_SEGMENT 0x23
#define USER_CODE_SEGMENT 0x1B

#define PEACHOS_MAX_PROGRAMS_ALLOCATIONS 1024
